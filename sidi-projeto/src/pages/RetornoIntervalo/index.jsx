...
const RetornoIntervalo = () => {
  ...
  return (
    <div className="container-intervalo-retorno">
      ...
      <div className="flex-container">
        ...
        <div className="flex-item-main">
          <div className="flex-item-saldo">
            ...
            <div><button className='buttonInter' type="submit" onClick={() => navigate("/intervalo")}> Retorno do Intervalo</button>
            </div>
            <div><button className='buttonSai' type="submit" onClick={() => navigate("/login")}>Saída</button>
            </div>
...
export default RetornoIntervalo;
